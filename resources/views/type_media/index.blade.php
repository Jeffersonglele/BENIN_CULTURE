...
<div class="row">
    <div class="col-sm-6">
        <h3 class="mb-0">
            </i>Liste des Types de Médias</h3>  
    </div>
    <div class="col-sm-6">
        <ol class="breadcrumb float-sm-end">
            <li class="breadcrumb-item"><a href="{{route('admin.culture')}}">Accueil</a></li>
            <li class="breadcrumb-item active" aria-current="page">Types de Médias</li>
        </ol>
    </div>
</div>
@endsection
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <table id="typemediaTable" class="table table-bordered table-striped display" style="width:100%">
                    <thead>
                        <tr>
                            <th>Nom du Type</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{ $type_media->nom_type_media }}</td>
                            <td class="text-center actions-cell">
                                <div class="btn-group" role="group">
                                    <a href="{{ route('admin.type_media.show', $type_media->id) }}" 
                                       class="btn btn-sm btn-warning btn-action" 
                                       data-bs-toggle="tooltip" 
                                       title="Voir les détails">
                                        <i class="bi bi-eye"></i>
                                    </a>
                                    <a href="{{ route('admin.type_media.edit', $type_media->id) }}" 
                                       class="btn btn-sm btn-primary btn-action" 
                                       data-bs-toggle="tooltip" 
                                       title="Modifier">
                                        <i class="bi bi-pencil"></i>
                                    </a>
                                    <form action="{{ route('admin.type_media.destroy', $type_media->id) }}" 
                                          method="POST" 
                                          class="delete-form" 
                ...
                <div class="btn-add-container float-end">
                    <a href="{{ route('admin.type_media.create') }}" class="btn btn-primary">
                        <i class="bi bi-plus-circle me-1"></i> Ajouter un type de Média
                    </a>
                </div>
            </div>
        </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        var table = document.getElementById('typemediaTable');
        if (table) {
            ...
            console.error('La table avec l\'ID "typemediaTable" n\'a pas été trouvée');
        }
