        ...
        <div class="card">
            <div class="card-body">
                        ...
                        <tr>
                            ...
                            <td class="text-center actions-cell">
                                <div class="btn-group" role="group">
                                    <a href="{{ route('type_media.show', $type_media->id) }}" 
                                       class="btn btn-sm btn-warning btn-action" 
                                       data-bs-toggle="tooltip" 
                                       title="Voir les détails">
                                        <i class="bi bi-eye"></i>
                                    </a>
                                    <a href="{{ route('type_media.edit', $type_media->id) }}" 
                                       class="btn btn-sm btn-primary btn-action" 
                                       data-bs-toggle="tooltip" 
                                       title="Modifier">
                                        <i class="bi bi-pencil"></i>
                                    </a>
                                    <form action="{{ route('type_media.destroy', $type_media->id) }}" 
                                          method="POST" 
                                          class="delete-form" 
                ...
                <div class="btn-add-container float-end">
                    <a href="{{ route('type_media.create') }}" class="btn btn-primary">
