...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <table id="regionsTable" class="table table-bordered table-striped display" style="width:100%">
                    <thead>
                        <tr>
                            <th>Nom</th>
                            <th>Population</th>
                ...
                <div class="btn-add-container float-end">
                    <a href="{{ route('admin.regions.create') }}" class="btn btn-primary">
                        <i class="bi bi-plus-circle me-1"></i> Ajouter une région
                    </a>
                </div>
            </div>
        </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        var table = document.getElementById('regionsTable');
        if (table) {
            ...
            console.error('La table avec l\'ID "regionsTable" n\'a pas été trouvée');
        }
