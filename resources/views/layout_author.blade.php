                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-widget="navbar-search" href="#" role="button">
                            <i class="bi bi-search text-dark color:black"></i>
                        </a>
                    </li>
                    <!--end::Navbar Search-->
                    ...
                    <li class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle d-flex align-items-center" data-bs-toggle="dropdown" aria-expanded="false">
                            <img src="{{ asset('images/users.jpg') }}" 
                                class="rounded-circle shadow me-2" 
                                alt="User Image" 
                                width="32" 
                                height="32">
                            <span class="d-none d-md-inline text-black">{{ Auth::user()->nom }} {{ Auth::user()->prenom }}</span>
                        </a>
            ...
            <div class="sidebar-wrapper">
                <nav class="mt-2">
                    ...
                    <ul
                        ...
                        <!-- Menu Contenus -->
                        <li class="nav-item">
                            <a href="{{ route('author.contenus.index') }}" class="nav-link">
                        ...
                        <!-- Menu Médias -->
                        <li class="nav-item">
                            <a href="{{ route('author.medias.index') }}" class="nav-link">
                        ...
                        <!-- Menu Commentaires -->
                        <li class="nav-item">
                            <a href="{{ route('author.commentaires.index') }}" class="nav-link">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('author.profile') }}" class="nav-link">
                                ...
                                <p class="text-black">Paramètres</p>
                            </a>
                        </li>
