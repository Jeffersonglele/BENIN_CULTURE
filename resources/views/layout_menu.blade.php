        ...
        <aside class="app-sidebar bg-body-secondary shadow" data-bs-theme="dark">
            ...
            <div class="sidebar-brand">
                ...
                <a href="{{url('/')}}" class="brand-link">
                    <!--begin::Brand Image-->
                    <img
                        src="{{asset('images/Photo 1 FM.jpg')}}"
                        alt="AdminLTE Logo"
                        class="brand-image " />
                    <!--end::Brand Image-->
                    <!--begin::Brand Text-->
                    <span class="brand-text fw-light text-black">BENIN CULTURE</span>
                    <!--end::Brand Text-->
                </a>
                <!--end::Brand Link-->
            </div>
            ...
            <div class="sidebar-wrapper">
                <nav class="mt-2">
                    ...
                    <ul
                        ...
                        <!-- Menu Langues -->
                        <li class="nav-item">
                            <a href="{{ route('langues') }}" class="nav-link">
                        ...
                        <!-- Menu Contenus -->
                        <li class="nav-item">
                            <a href="{{ route('contenus') }}" class="nav-link">
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{route('type_contenu')}}" class="nav-link">
                                        <i class="nav-icon bi bi-tags"></i>
                                        <p class="text-black">Types de Contenus</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{route('type_media')}}" class="nav-link">
