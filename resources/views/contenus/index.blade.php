                ...
                <table id="contenusTable" class="table table-bordered table-striped display" style="width:100%">
                    <thead>
                        <tr>
                            ...
                            <th style="width: 120px">Statut Up</th>
                            <th>Actions</th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center actions-cell">
                                <div class="btn-group" role="group">
                                    <!-- Bouton Valider (vert) -->
                                    <form action="{{ route('admin.contenus.updateStatus', $contenu->id) }}" method="POST" class="d-inline">
                                        @csrf
                                        @method('PATCH')
                            ...
                            <td class="text-center actions-cell">
                                <div class="btn-group" role="group">
                                    <a href="{{ route('admin.contenus.show', $contenu->id) }}" 
                                       class="btn btn-sm btn-warning btn-action" 
                                       data-bs-toggle="tooltip" 
                                    ...
                                    <form action="{{ route('admin.contenus.destroy', $contenu->id) }}" 
                                          method="POST" 
                                          class="delete-form" 
