...
<body>
            ...
            <div class="w-full lg:w-2/3">
                ...
                <div class="md:mt-[10%]">
                    <div
                                                ...
                                                <div class="swiper-slide relative swiper-slide-active"
                                                    ...
                                                    <picture
                                                        ...
                                                        <!--]--><img width="2560" height="1707"
                                                            ...
                                                            class="aspect-[4/3] md:aspect-[.64] w-full object-cover object-right transition translate-x-4 md:translate-x-8"
                                                            data-nuxt-pic=""
                                            ...
                                            <div class="swiper-wrapper" data-v-d0e669e8=""
                                                ...
                                                <div class="swiper-slide relative swiper-slide-active"
                                                    ...
                                                    <picture
                                                        ...
                                                        <source type="image/webp"
                                                            sizes="(max-width: 768px) 400px, 700px"
                                                            srcset="https://res.cloudinary.com/benin/image/upload/f_webp,q_80,w_400,h_283,c_fill/coton_2023e8d71 400w, https://res.cloudinary.com/benin/image/upload/f_webp,q_80,w_700,h_495,c_fill/coton_2023e8d71 700w, https://res.cloudinary.com/benin/image/upload/f_webp,q_80,w_800,h_566,c_fill/coton_2023e8d71 800w, https://res.cloudinary.com/benin/image/upload/f_webp,q_80,w_1400,h_990,c_fill/coton_2023e8d71 1400w">
                                                        <!--]--><img width="2560" height="1810"
                                                            alt="Coton"
                                                            onerror="this.setAttribute('data-error', 1)"
                                                            class="aspect-[4/3] md:aspect-[.64] w-full object-cover object-right transition translate-x-4 md:translate-x-8"
                                                            data-nuxt-pic=""
                                                            src="https://res.cloudinary.com/benin/image/upload/f_jpg,q_80,w_1400,h_990,c_fill/coton_2023e8d71"
                                                            sizes="(max-width: 768px) 400px, 700px"
                                                            srcset="https://res.cloudinary.com/benin/image/upload/f_jpg,q_80,w_400,h_283,c_fill/coton_2023e8d71 400w, https://res.cloudinary.com/benin/image/upload/f_jpg,q_80,w_700,h_495,c_fill/coton_2023e8d71 700w, https://res.cloudinary.com/benin/image/upload/f_jpg,q_80,w_800,h_566,c_fill/coton_2023e8d71 800w, https://res.cloudinary.com/benin/image/upload/f_jpg,q_80,w_1400,h_990,c_fill/coton_2023e8d71 1400w"
                                                            style="opacity: 1; transform: none;">
                                                    </picture>
                                                    <div class="absolute inset-0 z-[1] flex items-end bg-gradient-to-t from-black/40 via-black/20 to-black/0"
                                                        data-v-d0e669e8=""></div>
                        ...
                        <div class="flex gap-5 pb-10 pl-14 pr-4 pt-5 max-md:hidden">
                            <div style="" class="ml-6 flex items-center gap-2"><span
                                    class="iconify i-heroicons:map-pin-solid text-3xl"
                                    aria-hidden="true" style=""></span><span
                                    class="text-balance text-lg">La ville de Dassa-Zoumé</span>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Mise à jour de la carte lors du changement de slide
            function updateMapForSlide(slideIndex) {
                // Ajuster l'index pour la boucle infinie
                const realIndex = slideIndex % 12; // 12 régions au total
                const departmentIds = [
                    'alibori', 'atacora', 'borgou', 'donga', 'collines', 'plateau',
                    'zou', 'couffo', 'oueme', 'atlantique', 'mono', 'littoral'
                ];
                ...
                const activeDepartmentId = departmentIds[realIndex];
                const activePath = document.getElementById(activeDepartmentId);
                if (activePath) {
        ...
        document.addEventListener('keydown', function(event) {
            ...
            if (event.key === 'ArrowLeft') {
                swiper.slidePrev();
                updateMapForSlide(swiper.activeIndex);
        ...
        function updateMapForSlide(slideIndex) {
            ...
            const activeDepartmentId = departmentIds[slideIndex];
            const activePath = document.getElementById(activeDepartmentId);
            if (activePath) {
                activePath.classList.add('active');
            }
