                ...
                <table id="languesTable" class="table table-bordered table-striped display" style="width:100%">
                    ...
                    <tbody>
                        ...
                        <tr class="align-middle">
                            ...
                            <td>
                                <a href="{{ route('admin.langues.show', $langue->id) }}" class="btn btn-sm btn-info">
                                    <i class="bi bi-eye"></i>
                                </a>
                                <a href="{{ route('admin.langues.edit', $langue->id) }}" class="btn btn-sm btn-warning">
                                    <i class="bi bi-pencil"></i>
                                </a>
                                <form action="{{ route('admin.langues.destroy', $langue->id) }}" 
                                          method="POST" 
                                          class="delete-form" 
